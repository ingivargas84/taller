var cuentaDetalleTable = $("#cuenta-detalle-table").DataTable({
    "ajax": {
        "type": "GET",
        "url": "/cuentasPorPagar/getDetalleJson/" + $("#id").val() + "/",
        "data": function (json) {
