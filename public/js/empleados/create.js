...
//
// $.validator.addMethod("minSalario", function (value) {
// 	if (value.trim() < 2600) {
// 		$(this).val('');
// 		return false;
// 	} else {
...
var validator = $("#EmpleadoForm").validate({
	...
	messages: {
		...
		salario: {
			required: "Por favor, ingrese el salario del colaborador",
			onlyPositive: "Ingrese números positivos",
			minSalario: "Por favor, ingrese un número mayor a 2599"
		},
		direccion: {
