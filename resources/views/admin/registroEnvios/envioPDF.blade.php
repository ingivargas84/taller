...
<body>
    <table>
        <tr class="head">
            ...
            <td style="width:36%;text-align: center;">
                <br>
                <h2>Envío No. 00{{ $envio[0]->no_envio }}-{{ $envio[0]->anio }}<h2>
                <br>
            </td>
    ...
    <table id="datos">
        ...
        <tr>
            <td>{{ $envio[0]->ordenEquipo->no_orden_trabajo }}</td>
            <td>{{ $envio[0]->ordenEquipo->equipo->equipo }}</td>
            <td>{{ $envio[0]->empleado->nombres }}  {{ $envio[0]->empleado->apellidos }}</td>
            <td>{{ $envio[0]->receptor }}</td>
    ...
    <table style="margin-left: 3%;width: 700px" >
        <tr style="margin-left: 3%;">
            <td style="margin-left: 3%;"><b>Observaciones: </b> {{ $envio[0]->observaciones }}</td>
        </tr>
    </table>
    <br>
    <br>
    ...
    <table style="margin-left: 2%; font-size: 12px;">
        <tr>
        ...
        <tr>
            <td style="text-align: center;">{{ strtoupper($envio[0]->receptor) }}</td>
