    ...
    <table>
        <tr class="head">
            ...
            <td style="width:33%;text-align: right;">
                <br>
                <h2>Cotización 0{{ $head->no_cotizacion }}-{{ $head->anio }}</h2>
                <br>
            </td>
            <td  style="width:33%; text-align: right;">
        ...
        <table>
            <tr class="head">
                <td style="width:33%;">
                    ...
                    <span><b>Cliente:  </b>{{ $head->cliente->nombre }}</span><br>
                    <span><b>Direccion:  </b>{{ $head->cliente->direccion }}</span><br>
                    <span><b>Nit:  </b> {{ $head->cliente->nit }}</span><br>
                    <span><b>Teléfono:  </b> {{ $head->cliente->telefono }}</span>
                </td>
                <td style="width:33%; text-align: right; font-size: 17px">
                    <b>Total: </b> Q. {{  number_format($head->total,2, '.', ',') }}
                </td>
            </tr>
    </table>
    <table>
        ...
        <tr style="font-weight: bold;">
            ...
            <td></td>
            <td style="text-align: right">Q. </td>
            <td style='font-size: 17px; text-align: right'>{{ number_format($head->total,2, '.', ',') }}</td>
        </tr>
    </table>
    <div style="padding-left: 10px; position: fixed;bottom: 20;width: 90%;">
        <p>Esta cotización tiene validez unicamente 7 dias hábiles</p>
    </div>
