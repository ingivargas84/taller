...
<body>
    <table>
        <tr class="head">
            ...
            <td style="width:33%;text-align: right;">
                <br>
                <h3 style="text-align: center;">Reporte de Caja Chica por Rango de Fechas</h3>
                <p style="text-align: center; font-size: 14px">del {{ date('d/m/Y', strtotime($inicio)) }} al {{ date('d/m/Y', strtotime($final)) }}</p>
                <br>
            </td>
            <td style="width:33%; text-align: right;">
    ...
    <table>
        <tr style="text-align: left;">
            <p style="margin-top: -2px; opacity: .4; font-style: italic;">{{  date("d/m/Y", strtotime($lastRecord[0]->fecha)) }}</p>
        ...
        <tr>
            ...
            <td>Q.</td>
            <td style="text-align: right;">{{ number_format($day->saldo, 2, '.', ',') }}</td>
        </tr>
        @endforeach
    </table>
    <table>
        ...
        @foreach($movimientos as $key => $mov) 
            <tr>
            <td>{{ $key + 1 }}</td>
            <td style="margin-right: 40px">{{  date("d/m/Y H:i:s", strtotime($mov->fecha)) }}</td>
            @if($mov->tipo_movimiento_id == 1)
                <td style="padding-left: 20px">Entrada</td>
            @else 
                <td style="padding-left: 20px">Salida</td>
            @endif
        ...
        <tr style="font-weight: bold;">
            ...
            <td>Q.</td>
            <td style="text-align: right;">{{ number_format($lastRecord[0]->saldo, 2, '.',',')}}</td>
        </tr>
    </table>
</body>
