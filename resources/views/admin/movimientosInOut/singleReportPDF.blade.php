...
<body>
    <table>
        <tr class="head">
            ...
            <td style="width:33%;text-align: right;">
                <br>
                <h3 style="text-align: center;">Reporte de Caja Chica</h3>
                <p style="text-align: center; font-size: 14px">{{ date('d', strtotime($caja->fecha) ) }} de {{ $monthName }}, {{date('Y', strtotime($caja->fecha )) }}</p>
                @if(isset($last))
                <p style="text-align: center; font-size: 14px"><b>Saldo inicial:</b> {{ number_format($last->saldo, 2, '.', ',') }}</p>
                @endif
                <br>
            </td>
            <td style="width:33%; text-align: right;">
    ...
    <table>
        ...
        @foreach($movimientos as $key => $mov) 
            ...
            @endif
            <td style="margin-right:80px">{{$mov->descripcion}}</td>
        ...
        <tr style="font-weight: bold;">
            ...
            <td style="text-align: center">Q.</td>
            <td style="text-align: right;">{{number_format($caja->saldo, 2,'.',',')}}</td>
        </tr>
    </table>
</body>
