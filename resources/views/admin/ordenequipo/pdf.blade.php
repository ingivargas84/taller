...
<body>
    ...
    <table style="width: 700px" >
        <tr >
            <td style="text-align: center"><b><h2> ORDEN DE COBRO </h2></b> </td>
        </tr>
    </table>
    <table style="margin-left: 3%;width: 700px" >
        <tr style="margin-left: 3%;">
            <td style="margin-left: 3%;" id="fecha1"><b>Fecha de Entrega: <?php echo date("d-m-Y");?></b> </td>
        </tr>
    </table>
    ...
    <table style="margin-left: 3%;width: 700px" >
        <tr style="margin-left: 3%;">
            <td style="margin-left: 3%;"><b>Nombre del Cliente: </b>{{$q->cliente}}</td>
        </tr>
    </table>
    @endforeach
    ...
    <table id="datos">
        ...
        <tr>
            ...
            <td style="text-align: left;">{{$d->codigo}}</td>
    ...
    <table style="margin-left: 3%;width: 700px" >
        ...
        <tr style="margin-left: 3%;">
          <td></td>
            <td style="text-align: right;"><b>Total a Pagar:  Q.<?php
              $numero = $t->total;
              echo number_format($numero, 2, ".", ",");
    ...
    <table style="margin-left: 2%; font-size: 15px;">
        @foreach($empleado as $t)
        <tr>
            <td style="text-align: center;">
                ______________________________________
                <br>
                {{$t->nombre}} {{$t->apellido}} - {{$t->puesto}}
                <br>
                Empleado Asesor
            </td>
            <td style="text-align: center;">
    ...
    <table style="margin-left: 2%; font-size: 18px;">
