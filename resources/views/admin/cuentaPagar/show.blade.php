...
<section class="content-header">
  <h1>
    Cuenta por Pagar, Proveedor {{ $cuenta[0]->proveedor->nombre_comercial }}
    <small>Todos los detalles</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{route('dashboard')}}"><i class="fa fa-home"></i> Inicio</a></li>
    <li><a href="{{route('pagar.index')}}">Cuentas por Pagar</a></li>
...
@endsection
@section('content')
@include('admin.cuentaPagar.createAbonoModal')
...
@endsection
  ...
  <script src="{{asset('js/cuentaPagar/show.js')}}"></script>
  <script src="{{asset('js/cuentaPagar/createAbono.js')}}"></script>
  @endpush